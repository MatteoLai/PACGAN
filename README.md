[![DOI](https://zenodo.org/badge/651442582.svg)](https://zenodo.org/badge/latestdoi/651442582) [![Open in Code Ocean](https://codeocean.com/codeocean-assets/badge/open-in-code-ocean.svg)](https://codeocean.com/capsule/6317229/tree)
...
```
$ python Training/Generator.py --img_size 256 --n_images_xCLASS 100 100 --model_path /path/to/generator_model.pt --images_path /path/where/save/generated_images.nii.gz -j Training/config.json --device cuda --gpus 0 1
```
...
```
$ python Training/Discriminator.py --img_path /path/to/nifti_images_to_classify.nii.gz --model_path /path/to/discriminator_model.pt -j Training/config.json --device cuda --gpus 0 1
```
