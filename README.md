...
```
$ python Training/Generator.py --img_size 256 --n_images_xCLASS 100 100 --model_path /path/to/generator_model.pt --images_path /path/to/saved/images.nii.gz --device cuda --gpus 0 1
```
