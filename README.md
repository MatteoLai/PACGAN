...
```
$ python Training/Generator.py --img_size 256 --n_images_xCLASS 100 100 --model_path /path/to/generator_model.pt --images_path /path/where/save/generated_images.nii.gz --device cuda --gpus 0 1
```
...
```
$ python Training/Discriminator.py --img_path /path/to/nifti_images_to_classify.nii.gz --model_path /path/to/discriminator_model.pt --device cuda --gpus 0 1
```
